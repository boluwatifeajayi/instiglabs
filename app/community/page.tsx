...
function page() {
  return (
    ...
    <section className='px-12 sm:px-36 bg-[#F5FDFF] mt-24  py-20'>
        <div className='block container mx-auto justify-center sm:flex gap-2 sm:gap-36'>
            <div className='w-full sm:w-1/2  py-6 sm:py-24'>
            ...
            <p className='text-[#082630] sm:text-5xl text-4xl font-bold mt-2 mb-5'>
                ...
                <button  className="bg-transparent border-[#082630] border mt-8 px-6 py-3 text-xs sm:text-sm  text-[#082630] rounded-lg">
                  Join Community
                </button>
            </div>
        ...
        <div className='block container mx-auto justify-center sm:flex gap-2 sm:gap-36'>
            ...
            <p className='text-[#082630] sm:text-5xl text-4xl font-bold mt-2 mb-5'>
              Instig Cloud
                ...
                <p className='text-md'>Harness the potential of cloud computing with Instig Cloud. Learn how to leverage cloud technologies to scale your projects and enhance your capabilities.</p>
                <button  className="bg-transparent border-[#082630] border mt-8 px-6 py-3 text-xs sm:text-sm  text-[#082630] rounded-lg">
                  Join Community
                </button>
            </div>
    ...
    <section className='px-12 sm:px-36 py-20'>
        <div className='block container mx-auto justify-center'>

        <p className='text-[#40B8D3] text-center font-bold'>Contact Us</p>
        <p className='text-[#082630] sm:text-5xl text-4xl text-center font-bold mt-2 mb-5'>
        Got Questions?
        </p>
