      ...
      <div className='block mx-auto hero'>
        <div className="mx-auto">
          <div>
            ...
            <p className='text-[#082630] text-md sm:text-xl text-center mt-6'>
            Our mission at Instig Labs is to foster innovation and excellence in data analytics and AI. <br/>
            We are dedicated to providing the resources and knowledge needed to propel your career forward.
        ...
        >
          <div className='mx-auto mt-8 justify-center'>
            <Image className='ml-3' src={pic} alt='phone' />
          </div>
        </div>
      </div>
    </section>
    <section className='px-6 sm:px-36 py-20'>
